...
package com_roleypoly_auth_nackend
...
func init() {
	proto.RegisterType((*UserSlug)(nil), "com.roleypoly.auth.nackend.UserSlug")
	proto.RegisterType((*AuthChallenge)(nil), "com.roleypoly.auth.nackend.AuthChallenge")
}
...
var fileDescriptor_e7c305325d5462b7 = []byte{
	...
	0xd0, 0xcb, 0x83, 0xa8, 0x50, 0x52, 0xe2, 0xe2, 0x08, 0x2d, 0x4e, 0x2d, 0x0a, 0xce, 0x29, 0x4d,
	...
	0x51, 0x4a, 0xb1, 0x04, 0x33, 0x58, 0x16, 0x49, 0xc4, 0xa8, 0x9c, 0x8b, 0x1b, 0x64, 0x89, 0x13,
	0xc4, 0x5d, 0x42, 0x19, 0x5c, 0xc2, 0xee, 0xa9, 0x25, 0xc1, 0xa9, 0xc5, 0xc5, 0x99, 0xf9, 0x79,
	0x08, 0x9b, 0x55, 0xf4, 0x70, 0xfb, 0x45, 0x0f, 0xe6, 0x11, 0x29, 0x4d, 0x7c, 0xaa, 0x50, 0xbc,
	0xa2, 0xc4, 0x90, 0xc4, 0x06, 0x0e, 0x24, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x5f, 0xb7,
	0xad, 0x24, 0x3a, 0x01, 0x00, 0x00,
}
...
func (c *authBackendClient) GetSessionChallenge(ctx context.Context, in *UserSlug, opts ...grpc.CallOption) (*AuthChallenge, error) {
	...
	err := c.cc.Invoke(ctx, "/com.roleypoly.auth.nackend.AuthBackend/GetSessionChallenge", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthBackend_GetSessionChallenge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.roleypoly.auth.nackend.AuthBackend/GetSessionChallenge",
	}
...
var _AuthBackend_serviceDesc = grpc.ServiceDesc{
	ServiceName: "com.roleypoly.auth.nackend.AuthBackend",
